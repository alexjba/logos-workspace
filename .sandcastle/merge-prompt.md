...
- Otherwise `gh pr merge <n> --repo <fork> --merge --delete-branch` (sub-repo forks have no required checks; the merge is immediate).
...
4. Arm auto-merge immediately: `gh pr merge <n> --repo logos-fleet/logos-workspace --auto --merge --delete-branch`. Do NOT `--watch`; move on.
