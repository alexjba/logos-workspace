...
**Example**: Edit `logos-cpp-sdk`, then build `logos-basecamp` using your local version:

```bash
# Edit something in logos-cpp-sdk
vim repos/logos-cpp-sdk/src/something.cpp

# Build logos-basecamp — it will use YOUR local logos-cpp-sdk,
...
Under the hood, `ws build logos-basecamp --local logos-cpp-sdk` runs:
...
nixpkgs
  └── logos-cpp-sdk
        ...
        └── logos-liblogos
              ...
              └── logos-basecamp (aggregates many of the above)
...
- **Apps**: [logos-basecamp](https://github.com/logos-co/logos-basecamp), [logos-accounts-ui](https://github.com/logos-co/logos-accounts-ui), [logos-blockchain-ui](https://github.com/logos-blockchain/logos-blockchain-ui), [logos-chat-tui](https://github.com/logos-co/logos-chat-tui), [logos-chat-ui](https://github.com/logos-co/logos-chat-ui), [logos-chatsdk-ui](https://github.com/logos-co/logos-chatsdk-ui), [logos-execution-zone-wallet-ui](https://github.com/logos-blockchain/logos-execution-zone-wallet-ui), [logos-waku-ui](https://github.com/logos-co/logos-waku-ui), [logos-package-manager-ui](https://github.com/logos-co/logos-package-manager-ui), [logos-storage-ui](https://github.com/logos-co/logos-storage-ui), [logos-wallet-ui](https://github.com/logos-co/logos-wallet-ui), [logos-webview-app](https://github.com/logos-co/logos-webview-app)
...
The most common workflow: you're changing a library (e.g. `logos-cpp-sdk`) and want to see the effect in something that uses it (e.g. `logos-liblogos` or `logos-basecamp`).
...
```bash
# Build and run logos-basecamp using your local logos-cpp-sdk
ws run logos-basecamp --auto-local

# Or with explicit overrides
ws run logos-basecamp --local logos-cpp-sdk logos-liblogos
```
...
ws develop logos-basecamp --auto-local
```
...
ws build logos-basecamp --local logos-cpp-sdk
```
...
- **Infrastructure changes** (flake.nix, nix/, scripts/) trigger a build of the core chain: logos-cpp-sdk, logos-module, logos-liblogos, logos-package, logos-basecamp
