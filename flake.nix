{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-co/logos-protocol/9ba2f5a7e254a68f05d7dbfb87272334bb96679d";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
      url = "github:logos-co/logos-qt-sdk/b2ebecc0b7fb6a801dfbde9df60525a0c6dc0a82";
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/41ca4491f0163e0735511b6ac7d9020dec88a84c";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-view-module-runtime = {
      url = "github:logos-co/logos-view-module-runtime/b4d91ff5185ccfd6e0940e12bb9a811bee8b8c84";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-plugin-qt.follows = "logos-plugin-qt";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/209e9824e1f867a761a37c8c04df44cd310f6d52";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/22685ca6dd2e4ba45052afb8bbe4fb3ef1e4cbf1";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-plugin-qt = {
      url = "github:logos-co/logos-plugin-qt/1a0e399ef238ef3dbed367249f13a87029ca7fc1";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/e1a25706edb50aa7f34d02e08262ae7ffb3cb8db";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-standalone-app = {
      url = "github:logos-co/logos-standalone-app/96fb0c3a7b3295b7e97baadedad228a68d7af23e";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/c51ec519155f196d7f475b50c9300b01a3dd44e7";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-package-downloader = {
      url = "github:logos-co/logos-package-downloader/c8b22faba75c38629f9c7e928298f15b720df7fa";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-package-manager-module = {
      url = "github:logos-co/logos-package-manager-module/6f2b84fce9a8730d4d2599f1442fa7effcb672dd";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-manager.follows = "logos-package-manager";
    };
    logos-package-downloader-module = {
      url = "github:logos-co/logos-package-downloader-module/917cf3cb12a2b0b9f04ecfcb81fdc3402519f1e4";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-downloader.follows = "logos-package-downloader";
    };
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/b557332a605e1920fbb025860d0446703c1ec82f";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package.follows = "logos-package";
    ...
    logos-delivery-demo = {
      url = "github:logos-co/logos-delivery-demo/49d0a05eb61d5d8eefb269d1d47537e5debe3a91";
    ...
    logos-execution-zone-wallet-ui = {
      url = "github:logos-blockchain/logos-execution-zone-wallet-ui/d49c0f459e89b1b68ec0310a9289b1704a0d7917";
      inputs.lez_core.follows = "logos-execution-zone-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-execution-zone-module = {
      url = "github:logos-blockchain/logos-execution-zone-module/3716f57c706109e28a1175a83fa7f414fcdc19f3";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-libp2p-module = {
    ...
    logos-rust-sdk.url = "github:logos-co/logos-rust-sdk/bbfb42ff732f6858bb9459e935bd4170a83804bf";
    logos-logoscore-py = {
    ...
    logos-evm-keystore-module = {
      url = "github:logos-co/logos-evm-keystore-module/2d8fb2307bd9264acaee64017cf28586dacc304d";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    ...
    logos-evm-token-list-module = {
      url = "github:logos-co/logos-evm-token-list-module/5c6df5f0942ebf997236d4505ad7282fd50382d2";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
