{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/b65429e7a295268f148e55d6538162f811f33001";
    ...
    logos-module = {
      url = "github:logos-fleet/logos-module/f71d16ddc5779b50b188b3a3928a37c9ce90b2a1";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-package = {
      url = "github:logos-fleet/logos-package/cae2bba1658969b60d32696b9be0d3a5ed8e9b22";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-plugin-qt = {
    ...
    logos-package-manager = {
      url = "github:logos-fleet/logos-package-manager/f8a3193c9f2db152bc4125f007b5b759249f4a5a";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    process-stats = {
      url = "github:logos-fleet/process-stats/67176239e01322f1d6e2b7166cf0304d85beb56c";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-viewer = {
