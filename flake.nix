{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/7aa2182ab063efe2eb9c16766a956013e1c1187b";
    ...
    logos-view-module-runtime = {
      url = "github:logos-fleet/logos-view-module-runtime/03c26c41f77574ce4eee0537ccc4889c51dbfed5";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-liblogos = {
      url = "github:logos-fleet/logos-liblogos/5ac3cdc1c7e4058dcfe1825bbf42219390e5db44";
    ...
    logos-logoscore-cli = {
      url = "github:logos-fleet/logos-logoscore-cli/c5f54ee85e63a319555307fe8a3e7845f122c413";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-module-builder = {
      url = "github:logos-fleet/logos-module-builder/b0c47d422836512a0de26af61c518c44cc2d21dd";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
    ...
    nix-bundle-lgx = {
      url = "github:logos-fleet/nix-bundle-lgx/8423fc44de513bbd6f751fa14fe2889bc82f4575";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    logos-basecamp = {
      url = "github:logos-fleet/logos-basecamp/34dffc4f74202fffeb95507ccb43897f5da3a0d9";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
