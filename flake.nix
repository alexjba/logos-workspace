{
  ...
  inputs = {
    ...
    logos-nix.url = "github:logos-fleet/logos-nix/e637a1f5e871244d1c2df1e3c52a067f2eb406f2";
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/c1b0a0f554cd5197a974db7d6f805fc87ff07457";
    ...
    logos-module = {
      url = "github:logos-fleet/logos-module/2ec64c4a65f8966b5137cdba3a19a6498ce17b6d";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-liblogos = {
      url = "github:logos-fleet/logos-liblogos/be221c5749036343909fa0b109edecfb4d329fdd";
    ...
    logos-package = {
      url = "github:logos-fleet/logos-package/8d4236f9453bce8b44dfd2f85a5006af993b7ed2";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-plugin-qt = {
      url = "github:logos-fleet/logos-plugin-qt/f33f264abb6d628cc78cf926f9f33c7cc8252151";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-builder = {
      url = "github:logos-fleet/logos-module-builder/e9c8da45d3cf84e4207ba22d22e23ccccb1cb59a";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-basecamp = {
      url = "github:logos-fleet/logos-basecamp/d68173f73ca500c4eec422f2059585735943b88d";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-package-manager = {
      url = "github:logos-fleet/logos-package-manager/202af6fa0f0f4493bc59c8a609dff9326f78a18d";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-package-downloader = {
      url = "github:logos-fleet/logos-package-downloader/6fcf682539c501e927d72393872a4f36d6b1d2a9";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-js-sdk = {
      url = "github:logos-fleet/logos-js-sdk/6b6ccb5f10ea358ae8c9bee4264722dfb0aed76b";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-module.follows = "logos-module";
