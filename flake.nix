{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/1902bedf5478fd40e6dfcc1a8cd4ee190f7121a2";
    ...
    logos-package = {
      url = "github:logos-fleet/logos-package/35b36f76a5e73041265862dd76c82da62ada5d96";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-plugin-qt = {
    ...
    process-stats = {
      url = "github:logos-fleet/process-stats/776f2bdc9da72a2b14c747d511a28fd5771399a9";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-viewer = {
