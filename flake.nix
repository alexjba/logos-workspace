{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/d3bdf2a914b1793ec58860f481faca1d75733ea3";
    ...
    logos-liblogos = {
      url = "github:logos-fleet/logos-liblogos/dfd1e98c90a2835c76557e4459d20502b3a6c40f";
    ...
    logos-js-sdk = {
      url = "github:logos-fleet/logos-js-sdk/9ee3b9be758d4f1f3fa9306ba55235d8cb2e985e";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
