{
  ...
  inputs = {
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/5ef6ae015b069cfde70a727d096974054b12ddd1";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-view-module-runtime = {
      url = "github:logos-co/logos-view-module-runtime/318977b5b8ddc3edbbd7df7d6a1f14375ad8178c";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-plugin-qt.follows = "logos-plugin-qt";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/a49d301b5db64fbfdb09ad890b032cc86f01d3c1";
      ...
      inputs.logos-modules-state-module.follows = "logos-modules-state-module";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/fd540e858982932a30dbf031480c598dcfb423c5";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-module-loader-qt = {
      url = "github:logos-co/logos-module-loader-qt/1eadfec1b401932473e09b59db5989fe2e06d5e1";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/8ddaf834a7581bfe983b6ddfeb4032e02e7da234";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-modules-state-module = {
      url = "github:logos-co/logos-modules-state-module/dc13caa80164f2a941f788f4f96af193cd019879";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    nix-bundle-dir = {
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/7352e13963bf74ad908c2bf9ebfeff09a3c585e9";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-delivery-module = {
      url = "github:logos-co/logos-delivery-module/11243e2c52472d7c901c9d1603ac697b02e24682";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-delivery-demo = {
    ...
    logos-test-modules = {
      url = "github:logos-co/logos-test-modules/acd76f1011e5e5e9e64a2707e9498ed4215952fa";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-logoscore-cli.follows = "logos-logoscore-cli";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-nix.follows = "logos-nix";
