{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-fleet/logos-protocol/546698e1c1d14f7a078ebabab34f8ddd8481ce5f";
    ...
    logos-liblogos = {
      url = "github:logos-fleet/logos-liblogos/b7188da660fe29d944fa0c7ec0fbe8c7adde742d";
    ...
    logos-logoscore-cli = {
      url = "github:logos-fleet/logos-logoscore-cli/869c2f4e33b5e3d2128876e74582e2d8e07b4539";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-js-sdk = {
      url = "github:logos-fleet/logos-js-sdk/f96b4e4fdd3cee2df9de611a497996e66438076e";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
